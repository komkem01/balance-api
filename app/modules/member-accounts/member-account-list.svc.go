...
func (s *Service) ListMemberAccount(ctx context.Context, req *ListRequestService) ([]*ListItemService, *base.ResponsePaginate, error) {
	items, err := s.db.ListMemberAccounts(ctx)
	if err != nil {
		return nil, nil, err
	}
