...
func (s *Service) ListPrefix(ctx context.Context, req *ListRequestService) ([]*ListItemService, *base.ResponsePaginate, error) {
	items, err := s.db.ListPrefixes(ctx, req.IsActive)
	if err != nil {
		return nil, nil, err
	}
