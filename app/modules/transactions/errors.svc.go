...
var (
	...
	ErrTransactionTransferInvalidFromWalletID = errors.New("invalid transfer from wallet ID")
	ErrTransactionTransferInvalidToWalletID   = errors.New("invalid transfer to wallet ID")
	ErrTransactionTransferSameWallet          = errors.New("transfer wallet cannot be the same")
)
