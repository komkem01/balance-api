# AI Agent Instructions - balance Storage Service
...
func New(conf *config.Config[Config], dependencies...) *Module {
    tracer := otel.Tracer("balance.service_name.module_name")
...
```go
import "balance/internal/provider"
...
```bash
# Application
APP_NAME=balance-storage-service
